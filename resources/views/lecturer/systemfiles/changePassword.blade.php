                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="forms-sample">
                                <div class="form-group row">
                                    <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Current Password: </label>
                                    <div class="col-sm-9">
                                        <input required minlength="3" type="password" name="oldpass" class="form-control" id="" placeholder="Enter Your Current Password">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" name="conpass" class="form-control" id="" placeholder="Confirm Your New Password">
                                    </div>
                                </div>
